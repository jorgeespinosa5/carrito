...
<header>
    ...
    <center><h1>Reporte de Ventas por Clientes del <?php echo ($_GET['fechai']) ?> al <?php echo ($_GET['fechaf']) ?> </h1></center>
<?php
// Chart Configuration stored in Associative Array
$arrChartConfig = array(
        "chart" => array(
            "caption" => "Clientes",  // titulo
            "subCaption" => "Total comprado", // Subtitulo
            "xAxisName" => "Nombre Clientes", // eje x
...
$re=$con->query("
    SELECT sum(compras.subtotal) as total, usuarios.nombre
